...
--
-- Name: elements name_un; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements sym_un; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT sym_un UNIQUE (symbol);
...
--
-- Name: properties ato_fk; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT ato_fk FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
